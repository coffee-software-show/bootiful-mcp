...
* The original package name 'com.example.mcp-service' is invalid and this project uses 'com.example.mcp_service' instead.
...
```
$ docker run --rm -p 8080:8080 mcp-service:0.0.1-SNAPSHOT
```
